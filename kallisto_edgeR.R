...
setwd("C:/Users/Albert Doughan/Desktop/Bioinformatics review/R Data/Kallisto")

# Import counts data from kallisto into R.# path to the dataset.
dir = "C:/Users/Albert Doughan/Desktop/Bioinformatics review/R Data/Kallisto"
...
files = file.path(dir, metadatah$SampleID, "abundance.tsv")
...
txi.kallisto <- tximport(files, type="kallisto", tx2gene=tx2gene,countsFromAbundance = "no",
...
write.table(as.data.frame(sig_pvalue),"edgeR_kallisto.csv", row.names = T,sep=",",col.names=T)
